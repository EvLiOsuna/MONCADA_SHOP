...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://moncada2-be90c.firebaseio.com/"),
    refCart = new Firebase("https://moncada2-be90c.firebaseio.com/cart"),
    refUser = new Firebase("https://moncada2-be90c.firebaseio.com/users"),
    refCategory = new Firebase("https://moncada2-be90c.firebaseio.com/category"),
    refOrder = new Firebase("https://moncada2-be90c.firebaseio.com/orders"),
    refFeatured = new Firebase("https://moncada2-be90c.firebaseio.com/featured"),
    refMenu = new Firebase("https://moncada2-be90c.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
